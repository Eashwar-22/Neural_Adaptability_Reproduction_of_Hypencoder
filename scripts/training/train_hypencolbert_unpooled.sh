...
#SBATCH --output=logs/train_8gpu_colbert_%j.log
...
JOB_DIR="/dev/shm/hype_col_$SLURM_JOBID"
mkdir -p $JOB_DIR
...
# Copy config to RAM
cp my_configs/hypencolbert.yaml $JOB_DIR/config.yaml
...
echo "Data prep complete. Launching Hypen-ColBERT Training..."
echo "Architecture: Unpooled TextEncoder + MaxSim"
echo "Config: hypencolbert.yaml"
