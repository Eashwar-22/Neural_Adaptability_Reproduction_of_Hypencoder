...
#SBATCH --output=logs/train_control_be_mxbai_%j.log

source ~/.bashrc
conda activate hype_env

CONFIG_FILE="configs/train_control_be_mxbai.yaml"
...
echo "Starting Control Bi-Encoder Training with MXBAI Teacher (8 GPUs)..."
