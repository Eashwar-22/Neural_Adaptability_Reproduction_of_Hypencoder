...
#SBATCH --output=logs/inference_fiqa_lora_r8_%j.log
...
export ENCODED_OUTPUT_PATH="./assets/fiqa_encoded_lora_r8/encoded_items.docs"
export RETRIEVAL_DIR="./outputs/inference/fiqa_results_lora_r8"
