...
#SBATCH --output=logs/inference_trec_dl_2020_%j.log
...
# --- CONFIGURATION ---
export MODEL_NAME_OR_PATH="./checkpoints/hypencoder.6_layer_lora/merged_checkpoint-4000"
export IR_DATASET_NAME="msmarco-passage/trec-dl-2020/judged"

# SHARED ENCODING: Use the same encoded file as MS MARCO Dev to save time
export ENCODED_OUTPUT_PATH="./assets/msmarco_encoded_lora_r8/encoded_items.docs"
export RETRIEVAL_DIR="./outputs/inference/trec_dl_2020_results_lora_r8"
...
# Fix: Remove stale tmp files to avoid ConcurrentPushException
