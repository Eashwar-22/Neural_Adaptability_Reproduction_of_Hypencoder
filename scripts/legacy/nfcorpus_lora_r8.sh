#!/bin/bash
#SBATCH --job-name="nfcorpus_lora_r8"
...
#SBATCH --output=logs/inference_nfcorpus_lora_r8_%j.log
...
export ENCODED_OUTPUT_PATH="./assets/nfcorpus_encoded_lora_r8/encoded_items.docs"
export RETRIEVAL_DIR="./outputs/inference/nfcorpus_results_lora_r8"
