...
export RETRIEVAL_DIR="./outputs/inference/trec_dl_hard_results_lora_r8"
...
# --- STEP 1: ENCODE ---
# Skipping encoding (Shared corpus or pre-encoded). Uncomment to run.
# rm -f "$ENCODED_OUTPUT_PATH" "$ENCODED_OUTPUT_PATH.tmp"
# python hypencoder_cb/inference/encode.py ... (see other scripts)
