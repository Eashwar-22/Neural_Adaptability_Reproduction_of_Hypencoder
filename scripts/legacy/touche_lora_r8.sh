...
#SBATCH --output=logs/inference_touche_%j.log
...
export ENCODED_OUTPUT_PATH="./assets/touche_encoded_lora_r8/encoded_items.docs"
export RETRIEVAL_DIR="./outputs/inference/touche_results_lora_r8"
