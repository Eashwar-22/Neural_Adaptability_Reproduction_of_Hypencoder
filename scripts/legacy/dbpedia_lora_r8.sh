...
#SBATCH --output=logs/inference_dbpedia_%j.log
...
export ENCODED_OUTPUT_PATH="./assets/dbpedia_encoded_lora_r8/encoded_items.docs"
export RETRIEVAL_DIR="./outputs/inference/dbpedia_results_lora_r8"
