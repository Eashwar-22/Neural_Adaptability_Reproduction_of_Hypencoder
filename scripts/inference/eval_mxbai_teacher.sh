#!/bin/bash
#SBATCH --job-name="eval_mxbai_tch"
...
#SBATCH --output=logs/eval_mxbai_teacher_%j.log
...
BASE_OUT_DIR="./outputs/inference/mxbai_teacher_baseline"
...
echo "------------------------------------------------"
echo "All MXBAI Teacher evaluations complete."
