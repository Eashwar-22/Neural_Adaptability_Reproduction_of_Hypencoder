...
#SBATCH --output=logs/eval_ctrl_mxbai_%j.log

source ~/.bashrc
conda activate hype_env

MODEL_PATH="./checkpoints/control_be_teacher_mxbai"
BASE_OUT_DIR="./outputs/inference/control_be_teacher_mxbai"

export HF_HOME="${HYPENCODER_CACHE:-./cache}"
export HF_DATASETS_CACHE="${HYPENCODER_CACHE:-./cache}"

echo "========================================================"
echo "Evaluating Control Bi-Encoder (Mxbai Teacher)"
