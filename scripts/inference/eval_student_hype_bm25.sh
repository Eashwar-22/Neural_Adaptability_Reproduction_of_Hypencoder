...
#SBATCH --output=logs/eval_hype_bm25_%j.log

source ~/.bashrc
conda activate hype_env

MODEL_PATH="./checkpoints/distill_bm25"
BASE_OUT_DIR="./outputs/inference/distill_bm25"

export HF_HOME="${HYPENCODER_CACHE:-./cache}"
export HF_DATASETS_CACHE="${HYPENCODER_CACHE:-./cache}"

echo "========================================================"
echo "Evaluating Hypencoder (BM25 Teacher)"
