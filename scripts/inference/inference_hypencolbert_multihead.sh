#!/bin/bash
#SBATCH --job-name="multi_head_inf"
...
#SBATCH --output=logs/inference_multi_%j.log

# ==============================================================================
# SCRIPT: inference_hypencolbert_multihead.sh
# PURPOSE: Run Sharded Inference for Multi-Head HypenColBERT (32 Heads)
# USAGE:   sbatch scripts/inference/inference_hypencolbert_multihead.sh <dataset_key> <checkpoint_path>
# EXAMPLE: sbatch scripts/inference/inference_hypencolbert_multihead.sh dl19 checkpoints/hypen_colbert_multihead
# ==============================================================================
...
if [ -z "$DATASET_KEY" ] || [ -z "$CHECKPOINT_PATH" ]; then
    echo "Usage: sbatch scripts/inference/inference_hypencolbert_multihead.sh <dataset_key> <checkpoint_path>"
    exit 1
fi

# --- CONFIGURATION ---
BASE_OUT_DIR="./outputs/inference/hypencolbert_multihead"
...
echo "========================================================"
echo "Running Multi-Head HypenColBERT Inference"
