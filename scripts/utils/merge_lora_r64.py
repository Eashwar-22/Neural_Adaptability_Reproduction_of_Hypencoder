...
# Configuration
# Pointing to the final output directory which contains the last state
CHECKPOINT_PATH = "./checkpoints/hypencoder.6_layer_lora_r64"
BASE_MODEL_NAME = "jfkback/hypencoder.6_layer" 
OUTPUT_PATH = "./checkpoints/hypencoder.6_layer_lora_r64/merged_final"

print(f"--- Merging LoRA Weights (r=64) ---")
