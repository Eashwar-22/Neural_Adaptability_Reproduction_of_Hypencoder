...
def do_eval_and_pretty_print(
    ...
    if ir_dataset_name:
        ...
        raise ValueError("Must provide ir_dataset_name or qrel_json for evaluation.")
    
    # Calculate
    calculate_metrics_to_file(run, qrels, output_folder=Path(output_dir), metric_names=metric_names)
