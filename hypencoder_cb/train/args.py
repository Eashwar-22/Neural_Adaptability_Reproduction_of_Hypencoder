...
class HypencoderModelConfig:
    ...
    model_type: str = "hypencoder" # for debug_log_2228656.log
...
class HFTrainerConfig:
    ...
    # str options are: "full_shard", "auto_wrap", etc. Empty string to disable.
    fsdp: str = ""
...
class HypencoderTrainingConfig:
    ...
    trainer_config: HypencoderTrainerConfig = field(
        default_factory=lambda: HypencoderTrainerConfig(hf_trainer_config=HFTrainerConfig())
    )
